...
public class Learn extends AppCompatActivity {
    ...
    private void setHtmlContent() {
        ...
        // Установка содержимого для раздела 5
        TextView section5Content = findViewById(R.id.section5_content);
        String section5Html = "<p>Мошенники могут использовать различные методы для обмана, включая звонки, сообщения и фишинговые сайты.</p>"
                ...
                + "<br><br><br>"; // Два переноса строки для пустого пространства
